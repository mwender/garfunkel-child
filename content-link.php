		...
		<?php if ( !empty($link_title) && !empty($link_url) ) : ?>
			...
			<div class="post-link">
				...
				<?php if ( !empty($link_title) ) : ?>
					...
					<p><a href="<?php echo $link_url; ?>" target="_blank" title="<?php echo $link_title; ?>"><?php echo $link_title; ?> <span class="url"><?php echo garfunkel_url_to_domain( $link_url ); ?></span></a></p>
